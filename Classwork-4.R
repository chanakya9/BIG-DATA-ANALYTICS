...
data("anscombe")
anscombe
# generating levels for indicating group no.
...
library("ggplot2")
data(diamonds)
#only keeping premium and ideal cut diamonds
...
#used snaking for creating matrices
Data <- 1:20
...
# creating matrix using sticking method
r1 <- c("I", "am","happy")
r2 <- c ("what", "a", "day")
r3 <-1:3
...
D <-cbind(r1,r2,r3) #here becomes a column
D
...
FieldGoals
# Approx. no of goals per game rounded to 2 decimal points
...
?matplot
FieldGoals
t(FieldGoals) # used to transpose the matrix
...
myplot2(Points)
# normalized in-game metrics( to dodge injury skewed results)
